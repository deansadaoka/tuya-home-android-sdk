 ...
 */
public class LiveFragmentPresenter extends BasePresenter implements NetWorkStatusEvent {

    private static final String TAG = "LiveFragmentPresenter";
    private static final int WHAT_JUMP_GROUP_PAGE = 10212;
    protected Activity mActivity;
    protected IDeviceListFragmentView mView;

    public LiveFragmentPresenter(LiveFragment fragment, IDeviceListFragmentView view) {
