 ...
 */
public class SystemListFragmentPresenter extends BasePresenter implements NetWorkStatusEvent {
    ...
    public SystemListFragmentPresenter(DeviceListFragment fragment, IDeviceListFragmentView view) {
